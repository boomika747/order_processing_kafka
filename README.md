...
You can publish an order event directly to Kafka using the Kafka CLI:
...
order_processed if successful

order_failed if an error occurs
...
JSON is used as the event message format# order_processing_kafka
